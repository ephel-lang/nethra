...
let parser_type0 () =
  ...
  let result =
    response render @@ kind @@ Parsec.source (Utils.chars_of_string "type")
...
let parser_type1 () =
  let open Expression.Impl (Parsec) in
  let result =
    response render @@ kind @@ Parsec.source (Utils.chars_of_string "type1")
...
let parser_variable () =
  let open Expression.Impl (Parsec) in
  let result =
    response render @@ var @@ Parsec.source (Utils.chars_of_string "varName")
...
let parser_int () =
  let open Expression.Impl (Parsec) in
  let result =
    response render @@ int @@ Parsec.source (Utils.chars_of_string "42")
...
let parser_string () =
  let open Expression.Impl (Parsec) in
  let result =
    response render @@ string @@ Parsec.source (Utils.chars_of_string "\"Hello\"")
...
let parser_char () =
  let open Expression.Impl (Parsec) in
  let result =
    response render @@ char @@ Parsec.source (Utils.chars_of_string "'H'")
